...
const SidebarLogo = (props: PropsType) => {
  ...
  return (
    <div className='app-sidebar-logo px-6 d-flex align-items-center' id='kt_app_sidebar_logo'>
      <Link to='/manage/dashboard' className='d-flex align-items-center'>
        {config.layoutType === 'dark-sidebar' ? (
          <img
            alt='Logo'
            src={toAbsoluteUrl('/media/logos/nvkh_logo.svg')}
        ...
        {(!isMinimized || isHovered) && (
          <span className="logo logo-title fs-5 ms-5 fw-bolder">
