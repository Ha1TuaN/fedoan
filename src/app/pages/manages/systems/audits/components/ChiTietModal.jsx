...
import {requestPOST, requestPUT} from 'src/utils/baseAPI';
...
const ModalItem = (props) => {
  ...
  const onFinish = async () => {
    ...
    try {
      ...
      const res = id
        ? await requestPUT(`api/v1/huongdansudungs/${id}`, formData)
        : await requestPOST(`api/v1/huongdansudungs`, formData);
      if (res) {
