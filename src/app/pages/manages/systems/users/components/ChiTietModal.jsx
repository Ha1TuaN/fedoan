...
import {Form, Input, Select, Spin, Tooltip, Space, Button as Btn} from 'antd';
  ...
  const onFinish = async () => {
    ...
    try {
      ...
      const res = id
        ...
        : await requestPOST_NEW(`api/users`, {...formData, password: 'Tandan@123', confirmPassword: 'Tandan@123'});
      if (res.status === 200) {
              ...
              <div className='row '>
                ...
                <div className='col col-xl-4'>
                  <div className='row'>
                    ...
                    <div className='col-xl-12 col-lg-12'>
                      <FormItem label='Đơn vị' name='organizationUnitId'>
                        <TreeSelect
                          showSearch
                          style={{
                            width: '100%',
