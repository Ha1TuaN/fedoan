...
const ModalItem = (props) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoadding(true);
      const res = await requestGET(`api/v1/kehoachs/${id}`);
  ...
  const onFinish = async () => {
    ...
    try {
      ...
      const res = id ? await requestPUT_NEW(`api/v1/kehoachs/${id}`, formData) : await requestPOST_NEW(`api/v1/kehoachs`, formData);
            ...
            <Form form={form} layout='vertical' /* initialValues={initData} */ autoComplete='off'>
              <div className='row'>
                <div className='col-xl-6 col-lg-6'>
                  <FormItem label='Tên' name='tenKeHoach' rules={[{required: true, message: 'Không được để trống!'}]}>
                    <Input
                      placeholder=''
                      onChange={(e) => {
                ...
                <div className='col-xl-6 col-lg-6'>
                  <FormItem label='Thời gian' name='thoiGian'>
                    <DatePicker />
                  </FormItem>
                </div>
                <div className='col-xl-6 col-lg-6'>
