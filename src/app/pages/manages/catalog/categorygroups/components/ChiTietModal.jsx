...
import {removeAccents, translateToEnglish} from 'src/utils/slug';
...
const ModalItem = (props) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoadding(true);
      const res = await requestGET(`api/v1/categorygroups/${id}`);
  ...
  const onFinish = async () => {
    ...
    try {
      ...
      const res = id ? await requestPUT_NEW(`api/v1/categorygroups/${id}`, formData) : await requestPOST_NEW(`api/v1/categorygroups`, formData);
